...
def main( kwd ):
    ...
    rzlsh = set_tlog_parms( tlog ,'check_ocm' ,kind='check_ocm', reload_jyzd='yes' )
    ...
    try:
        ...
        buf = str(len_buf).rjust( 5, '0').encode('utf-8') + kwd['BUF']
    ...
    try:
        ...
        # 接收报文长度
        jsddbw_len = int( s.recv( 5 ).decode( 'utf-8' ) )
