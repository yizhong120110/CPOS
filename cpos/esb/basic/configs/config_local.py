...
######################## 数据库的连接 -------（ 数据库主机ip ）
DB_CONSTR = dict( dsn = '127.0.0.1:1521/orcl' , user = 'enc' , password = 'enc' )
...
######################## 缓存控制 -----------（业务主机ip）
MEMCACHE_IPS = ['127.0.0.1:5628']


######################## mongodb数据库------（数据库主机ip）
MONGODB_IPS = ['127.0.0.1:5625']
...
LOG_ENABLE_CONSOLE = '%s/log/esbapp.log'%(userhome)
